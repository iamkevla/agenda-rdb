 ...
 *  - Moved code into Agenda.dbInit() and call same for all initialization functions.
...
Agenda.prototype.rethink = function (rdb, table, cb) {
    r = this._rdb = rdb;
    this.dbInit(table, cb); // NF 20/04/2015
    return this;
};
        ...
        cb(new Error('No RethinkDB Connection'));
         ...
         this._table.filter(function(job){
            ...
            .update({
                ...
                if (!error && result.changes && result.changes[0]['new_val']) {
